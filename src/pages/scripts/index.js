        ...
        <React.Fragment>
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="Tables" breadcrumbItem="Scripts" />
                                                ...
                                                <Tbody>
                                                    <Tr>
                                                        ...
                                                        <Td>
                                                            ...
                                                            >
                                                                <i className="mdi mdi-folder d-block font-size-16"></i>
                                                            </Link>
                                                        </Td>
                                                        <Td>
                                                        <button                        
                                                        ...
                                                        >
                                                            <i className="mdi mdi-content-duplicate d-block font-size-16"></i>
                                                        </button>
                                                        </Td>
